...
- **PROGRESS.md** — live status. At the END of each work session, update the "Now"
  ...
  Keep it short.
- **DAYS_2_3_walking_skeleton.md**, **DAYS_4_5_harden_tools.md**, and
  **DAYS_6_7_verification.md** (all done) — turn-by-turn build specs per
  milestone. Each new milestone gets its own spec file; check PROGRESS.md for
  which milestone is current and whether its spec file has been written yet.
